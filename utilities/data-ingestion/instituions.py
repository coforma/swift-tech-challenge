            ...
            try:
                table.put_item(
                    Item={
                        ...
                        "raceDemographics":   {
                            "percentWhite": convertToNumeric(
                                institution_data[14]),
                            "percentBlack": convertToNumeric(
                                institution_data[15]),
                            "percentAsian": convertToNumeric(
                                institution_data[17]),
                            "percentHispanic": convertToNumeric(
                                institution_data[16]),
                            "percentAian": convertToNumeric(
                                institution_data[18]),
                            "percentNhpi": convertToNumeric(
                                institution_data[19]),
                        ...
                        "admissionRate": convertToNumeric(
                            institution_data[13]),
                        "averageAttendanceCost": convertToNumeric(
                            institution_data[35]),
                        "tuitionInState": convertToNumeric(
                            institution_data[36]),
                        "tuitionOutOfState": convertToNumeric(
                            institution_data[37]),
